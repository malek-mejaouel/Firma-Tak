...
$publicationC = new ProductC();
$publication = $publicationC->showProduct($id);
...
/F1 16 Tf
50 700 Td
(" . str_replace(array("\n", "\r"), ' ', $publication['Nom_Produit']) . ") Tj

/F1 12 Tf
0 -30 Td
(" . str_replace(array("\n", "\r"), ' ', $publication['Prix_Unitaire']) . ") Tj

/F1 10 Tf
0 -30 Td
(quantite de produit: " . $publication['Quantite'] . ") Tj
ET
endstream
endobj
