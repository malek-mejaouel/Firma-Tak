                              ...
                              <div class="carousel-inner" role="listbox">
                                 <div class="carousel-item active">
                                    <picture>
                                       ...
                                       <img srcset="images/bani.jpg" alt="responsive image" class="d-block img-fluid">
                                    </picture>
...
.dark-mode button {
        ...
        #darkModeButton {
    position: absolute;
    top: calc(40px +2cm); /* Move the button 4 cm up from the initial position */
    right: calc(20px + 3cm); /* Move the button 6 cm to the right */
